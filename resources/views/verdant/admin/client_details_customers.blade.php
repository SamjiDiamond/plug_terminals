...
{{--                    </div>--}}
        ...
        @include('verdant.admin.partials.client_nav', ['active' => "c"])
        ...
        <div class="row mb-4">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="materialCard">
                    ...
                    <div class="dashboardSummaryCount flex-between">
                        <h2>{{number_format($customers_active)}}</h2>
                ...
                <div class="materialCard materialTableContainer mt-5">
                    <div class="materialCardTitle">
                        <div class="materialCardInline flex-between">
                            <div>
                                <h4 id="lists">Customers Table</h4>
...
@section('scripts')
    ...
    <script>
        // Clients Pie Chart
        let clientsPieChartSeries = [500, 50];
        ...
        let clientsLineChartSeries = [
            {
                name: "Clients",
                data: [1000, 760, 340, 1240, 850, 1100, 650]
            }
        ];
