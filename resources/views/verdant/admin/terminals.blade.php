        ...
        <div class="row mb-4">
            <div class="col-sm-6 col-lg-4">
                <div class="materialCard">
                    ...
                    <div class="dashboardSummaryCount flex-start">
                        <div>
                            <h2>{{number_format($terminal_total)}}</h2>
{{--                            <small class="orange-color">+20%</small><small> vs May</small>--}}
                        </div>
                        <div>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="materialCard">
                    ...
                    <div class="dashboardSummaryCount flex-start">
                        <div>
                            <h2>{{number_format($terminal_mapped)}}</h2>
{{--                            <small class="green-color">+12%</small><small> vs May</small>--}}
                        </div>
                        <div>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="materialCard">
                    ...
                    <div class="dashboardSummaryCount flex-start">
                        <div>
                            <h2>{{number_format($terminal_unmapped)}}</h2>
{{--                            <small class="red-color">+8%</small><small> vs May</small>--}}
                        </div>
                        <div>
                ...
                <div class="materialCard materialTableContainer mt-5">
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                <td>{{$term->id}}</td>
                                <td><a href="{{route('admin.clients.details', $term->id)}}">{{$term->name}}</a></td>
                                <td>{{$term->Terminals->count()}}</td>
                                <td>{{$term->Terminals->where("status", 1)->count()}}</td>
                                <td>{{$term->Terminals->where("status", 0)->count()}}</td>
                                <td><a href="{{route('admin.clients.terminal', $term->id)}}">
