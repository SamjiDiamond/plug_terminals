...
@section('contents')
    <div class="container-fluid dashboardSummary">
        ...
        @include('verdant.admin.partials.vas_nav', ['active' => "d"])
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <th scope="col">Provider Price</th>
                            ...
                            <tbody>
                                @foreach($data as $trans)
                                    ...
                                    <td>{{\Carbon\Carbon::parse($trans->created_at)->format('Y-m-d')}}</td>
                                        <td>
                                            <a href="{{route('admin.editdata',$trans->id)}}">
                                            ...
                                            <label class="toggleSwitch nolabel">
                                                <input type="checkbox" name="status" value="0" id="myCheckBox"
                                                       {{$trans->status =="1"?'checked':''}} onclick="window.location='{{route('admin.dataswitch', $trans->id)}}'"/>
                                                <span>
                                                <span>off</span>
                                                <span>on</span>
                                             </span>
