...
{{--                    </div>--}}
        ...
        @include('verdant.admin.partials.client_nav', ['active' => "tt"])
                        ...
                        <div class="col-sm-5 border-right">
                            <div class="twoItemsPerRow">
                                <div>
                                    ...
                                    <h1>&#8358; {{number_format($trx_total)}}</h1>
                                </div>
                                <!-- <div>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22.6564 1.7876V7.1156H17.3284" stroke="#51526C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M1.34363 22.2117L1.34363 16.8837L6.67163 16.8837" stroke="#51526C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M0.900146 11.9997C0.900147 9.65557 1.64224 7.37165 3.02006 5.47524C4.39788 3.57883 6.3407 2.16729 8.57006 1.44293C10.7994 0.718567 13.2009 0.718568 15.4302 1.44293C17.6596 2.1673 19.6024 3.57884 20.9802 5.47525" stroke="#51526C" stroke-width="1.5" stroke-linecap="round"/><path d="M23.0999 12C23.0999 14.3441 22.3578 16.628 20.98 18.5244C19.6021 20.4208 17.6593 21.8324 15.43 22.5567C13.2006 23.2811 10.7991 23.2811 8.56978 22.5567C6.34041 21.8324 4.3976 20.4208 3.01978 18.5244" stroke="#51526C" stroke-width="1.5" stroke-linecap="round"/><rect x="1.5022" y="17.0996" width="1.5" height="1.5" fill="#51526C"/><rect x="21.0022" y="5.24951" width="1.5" height="1.5" fill="#51526C"/></svg>
                                </div> -->
                            </div>
                            <a href="#transactionsTable">
                                <button class="materialButtonIcon">
                                    <span>View Recent Transactions</span>
                                    <span class="buttonIcon">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18.0699 14.4299L11.9999 20.4999L5.92993 14.4299" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path><path d="M12 3.5V20.33" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                                            </span>
                                </button>
                            </a>
                        </div>
                        <div class="col-sm-7">
                            <div class="twoItemsPerRow transactionSummary">
                                <div>
                                    <h6 class="grey-color">Successful Transaction</h6>
                                    <h3>&#8358; {{number_format($trx_success)}}</h3>
                                </div>
                                <div>
                                    <h6 class="grey-color">Failed Transaction</h6>
                                    <h3>&#8358; {{number_format($trx_failed)}}</h3>
                                </div>
                                <div>
                                    <h6 class="grey-color">Refunded Transaction</h6>
                                    <h3>&#8358; {{number_format($trx_reversed)}}</h3>
                                </div>
                                <div>
                                    <h6 class="grey-color">Pending Transaction</h6>
                                    <h3>&#8358; {{number_format($trx_pending)}}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="transactionsTable" class="materialCard materialTableContainer mt-5">
                    <div class="materialCardTitle">
                        <div class="materialCardInline flex-between">
                            <div>
                                <h4 id="lists">Transactions Table</h4>
