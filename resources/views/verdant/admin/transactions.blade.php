            ...
            <div class="col-sm-6 col-lg-4">
                <div class="materialCard">
                    ...
                    <div class="dashboardSummaryCount">
                        <h3 class="mb-3">₦ {{number_format($trx_total)}}</h3>
{{--                        <span class="orange-theme">--}}
{{--                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18.6806 13.9783L15.4706 10.7683L13.5106 8.79828C12.6806 7.96828 11.3306 7.96828 10.5006 8.79828L5.32056 13.9783C4.64056 14.6583 5.13056 15.8183 6.08056 15.8183H11.6906H17.9206C18.8806 15.8183 19.3606 14.6583 18.6806 13.9783Z"></path></svg>--}}
{{--                                    250,000--}}
{{--                                </span>--}}
{{--                        <small><span class="orange-color">+12%</span>vs May</small>--}}
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="materialCard">
                    ...
                    <div class="dashboardSummaryCount">
                        <h3 class="mb-3">₦ {{number_format($trx_success)}}</h3>
...
{{--                        <small><span class="green-color">+20%</span>vs May</small>--}}
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="materialCard">
                    ...
                    <div class="dashboardSummaryCount">
                        <h3 class="mb-3">₦ {{number_format($trx_failed)}}</h3>
{{--                        <span class="red-theme">--}}
{{--                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M17.9188 8.17969H11.6888H6.07877C5.11877 8.17969 4.63877 9.33969 5.31877 10.0197L10.4988 15.1997C11.3288 16.0297 12.6788 16.0297 13.5088 15.1997L15.4788 13.2297L18.6888 10.0197C19.3588 9.33969 18.8788 8.17969 17.9188 8.17969Z"></path></svg>--}}
{{--                                    50,000--}}
{{--                                </span>--}}
{{--                        <small><span class="red-color">+8%</span>vs May</small>--}}
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="materialCard">
                    ...
                    <div class="dashboardSummaryCount">
                        <h3 class="mb-3">₦ {{number_format($trx_pending)}}</h3>
...
{{--                        <small><span class="yellow-color">+12%</span>vs May</small>--}}
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="materialCard">
                    ...
                    <div class="dashboardSummaryCount">
                        <h3 class="mb-3">₦ {{number_format($trx_reversed)}}</h3>
{{--                        <span class="green-theme">--}}
{{--                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18.6806 13.9783L15.4706 10.7683L13.5106 8.79828C12.6806 7.96828 11.3306 7.96828 10.5006 8.79828L5.32056 13.9783C4.64056 14.6583 5.13056 15.8183 6.08056 15.8183H11.6906H17.9206C18.8806 15.8183 19.3606 14.6583 18.6806 13.9783Z"></path></svg>--}}
{{--                                    250,000--}}
{{--                                </span>--}}
...
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <div class="transactionsBarChart"></div>--}}
{{--                </div>--}}
{{--            </div>--}}
...
{{--                        <div class="materialCardInline">--}}
{{--                            <div>--}}
{{--                                <h5>Clients with highest transactions</h5>--}}
{{--                                <!--<h6 class="headingH6">Payouts Rate</h6>-->--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <div class="materialListPanel">--}}
{{--                        <a href="clients-single.html">--}}
...
{{--                                <div>--}}
{{--                                    <h5>Victor Eben</h5>--}}
{{--                                    <h6 class="grey-color">Lekki</h6>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </a>--}}
{{--                        <div><h6 class="green-theme">May 6</h6></div>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
                ...
                <div class="materialCard materialTableContainer mt-5">
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                <td>{{$trx->id}}</td>
                                <td><a href="{{route('admin.clients.details', $trx->id)}}">{{$trx->name}}</a></td>
                                <td>{{$trx->Transactions->count()}}</td>
                                <td>{{$trx->Transactions->where('status', 1)->count()}}</td>
                                <td>{{$trx->Transactions->where('status', 4)->count()}}</td>
                                <td>{{$trx->Transactions->where('status', 0)->count()}}</td>
                                <td>{{$trx->Transactions->where('status', 2)->count()}}</td>
                                <td><a href="{{route('admin.clients.transactions', $trx->id)}}">
...
@section('scripts')
    ...
    <script>
        ...
        let transactionChartSelector = 'transactionsBarChart';
