...
{{--                    </div>--}}
        ...
        @include('verdant.admin.partials.client_nav', ['active' => "t"])
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                @foreach($terminals as $term)
                                    ...
                                    <td>
                                        @if($term->agent_id != null)
                                            {{$term->agent->firstname}} {{$term->agent->lastname}}
                                        @else
                                            Unassigned
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        @if($term->status == 1)
                                            <a class="btn btn-danger btn-sm" href="{{route('admin.terminal.revoke',$term->id)}}">Revoke</a>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
