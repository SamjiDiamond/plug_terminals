...
{{--                    </div>--}}
        ...
        @include('verdant.admin.partials.client_nav', ['active' => "i"])
                ...
                <div class="materialCard">
                    <div class="twoItemsPerRow">
                        <div>
                            ...
                            <h2>&#8358; {{number_format($client->wallet)}}</h2>
                        </div>
                        <div>
                            <h5 class="grey-color">Book Balance</h5>
                            <h2>&#8358; {{number_format($client->wallet)}}</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="materialCard materialTableContainer mt-5">
                    <div class="materialCardTitle">
                        <div class="materialCardInline flex-between">
                            <div>
                                <h4 id="lists">Revenue Wallet Transaction</h4>
