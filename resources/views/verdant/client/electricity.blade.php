...
@section('contents')
    <div class="container-fluid dashboardSummary">
        ...
        @include('verdant.admin.partials.client_vas_nav', ['active' => "e"])
            ...
            <div class="materialCard materialTableContainer mt-5">
                <div class="materialCardTitle">
                    <div class="materialCardInline flex-between">
                        <div>
                            <h4 id="lists">Electricity Table</h4>
                    ...
                    <table class="table table-borderless">
                        ...
                        @foreach($all as $cli)
                            <tr>
                                ...
                                <td><a href="{{route('editElectricity',$cli->id)}}">
                                    ...
                                    <label class="toggleSwitch nolabel">
                                        <input type="checkbox" name="status" value="0" id="myCheckBox"
                                               {{$cli->status =="1"?'checked':''}} onclick="window.location='{{route('electricityModify', $cli->id)}}'"/>
                                        <span>
                                                <span>off</span>
                                                <span>on</span>
                                             </span>
