                ...
                <div class="col-sm-5 col-lg-5">
                    <div class="materialCard profileSettings">
                        <div class="profilePhoto">
                            @if($net->parentData->type=='mtn-data')
                            <img width="100" src="{{asset('verdant_assets/mtn.png')}}" alt="">
                            @elseif($net->parentData->type=='glo-data')
                                <img width="100" src="verdant_assets/glo.jpeg" alt="">
                    ...
                    <div class="materialCard">
                        <form method="post" action="{{route('done')}}">
                            ...
                            <div class="mt-4 mb-4">
                                ...
                                <input type="text" class="subject" name="sprice" value="{{$net->price}}" placeholder="Your Price" id="" required></div>
                                <div class="mt-4 mb-4">
