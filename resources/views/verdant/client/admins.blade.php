                                                        ...
                                                        <div class="col-sm-6 col-lg-4">
                                                            <div class="materialCard">
                                                                ...
                                                                <div class="dashboardSummaryCount flex-between">
                                                                    ...
                                                                    <a href="{{route('adminResetpassword', $acct->id)}}" class="orange-theme">
                                                                        Click here
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-sm-6 col-lg-4">
                                                            <div class="materialCard">
                                                                ...
                                                                <div class="dashboardSummaryCount flex-between">
                                                                    ...
                                                                    <a href="{{route('edAdmin', $acct->id)}}"  class="green-theme">
                                                                        Click Here
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-sm-6 col-lg-4">
                                                            <div class="materialCard">
                                                                ...
                                                                <div class="dashboardSummaryCount flex-between">
                                                                    ...
                                                                    <a href="{{route('deleteAdmin', $acct->id)}}" class="red-theme">
                                                                        Delete Account
                                                                    </a>
                                                                </div>
                                                            </div>
