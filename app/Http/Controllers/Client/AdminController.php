...
class AdminController extends Controller
{
    ...
    function admins(){
        ...
        $data['i']=1;
        return view('verdant.client.admins', $data);
    }
    ...
    function createAdmin(Request $request){
        ...
        return redirect()->route('admins')->with("success", "Admin created successfully. Login credentials has been sent to the email provided.");
    ...
    function resetPassword($id){
        ...
        return redirect()->route('admins')->with("success", "Admin password reset successfully. New password has been sent to the admin email.");
    ...
    function edAdmin($id){
        ...
        return redirect()->route('admins')->with("success", "Admin status changed successfully.");
    }
